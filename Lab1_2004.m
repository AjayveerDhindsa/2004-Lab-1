...
C_l = [-0.2446 -0.1465 -0.0401 0.0658 0.1717 0.2737 0.4058 0.5143 0.6167 0.7194 0.8201 0.9193 1.0129 1.1027 1.1844 1.2533 1.2865 1.2763 1.2329 1.1635 1.0951]; %Just Wings
C_d = [0.0140 0.0091 0.0073 0.0059 0.0049 0.0043 0.0045 0.0050 0.0057 0.0066 0.0078 0.0092 0.0112 0.0134 0.0165 0.0201 0.0252 0.0332 0.0475 0.0720 0.1502]; %Just Wings
...
a_0data = a_attack(1:14);
C_ldata = C_l(1:14);
C_ddata = C_d(1:14);

%Using y=mx+b to find a_0 on 2D wing plot
a_0 = polyfit(a_0data,C_ldata,1);
a_02D = a_0(1);
